...
export default function ContactPage() {
  return (
    <LegalPage eyebrow="Human support" intro="Questions about a result, your data, or a purchase can be sent directly to our support inbox." title="Contact DeepPersona AI">
      ...
      <PolicySection title="Business identity"><p>DeepPersona AI is operated by NEXUS FRONTIER LLC. For product, purchase, refund, or privacy support, contact bruce@deeppersonaai.com.</p></PolicySection>
    </LegalPage>
  );
}
