...
test("Beijing midnight starts the next reporting day", () => {
  const rows = completeAdminStatsSeries("today", [], new Date("2026-09-09T16:01:00Z"));
  assert.equal(rows[0].day, "2026-09-10 00:00");
});
